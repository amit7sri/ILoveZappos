...
public class TinyDB {
    ...
    public ArrayList<Items> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();
    	...
    	for(String jObjString : objStrings){
            Items value  = (Items) gson.fromJson(jObjString,  mClass);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, List<Items> list){
    	checkForNullKey(key); 
    	Gson gson = new Gson();
